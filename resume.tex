...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Development of a system for multi-cloud and multi-cluster generative AI inference at scale. Utilizing NVIDIA Dynamo,
  \href{https://www.linkedin.com/posts/vadimeisenberg_llmd-kubernetes-llminference-activity-7411405769872506880-RZqy}{llm-d},
  Envoy AI Gateway.
\item Integration of NeuReality hardware and software with Kubernetes ecosystem: device plugins, Calico dataplane driver, operators.
\end{tightemize}
\sectionsep
...
Contributor \href{https://github.com/istio/istio/graphs/contributors}{\#45} to \href{https://github.com/istio/istio}{istio/istio}, \href{https://github.com/istio/istio.io/graphs/contributors}{\#10} to \href{https://github.com/istio/istio.io}{istio/istio.io}. Consulting a large enterprise on their Istio adoption.
