...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Currently: development of \href{https://istio.io}{Istio Service Mesh}, ingress/egress traffic control, multi-cluster/multi-mesh, \href{http://eng.istio.io/maintainers}{maintainter}.
...
\section{PERSONALITY}
Passionate about Software Development \textbullet{} Dedicated to execution \textbullet{}  Quick learner \textbullet{} Marathon runner\\
...
StackOverflow: \href{http://stackoverflow.com/users/553720/vadim-eisenberg}{553720/vadim-eisenberg}, reputation 2422 \\
