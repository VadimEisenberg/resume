...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Composed a road map and architecture of integration of NeuReality hardware and software with Kubernetes
\item Implemented device plugins, Calico dataplane driver, operators
\item Designed \href{https://www.neureality.ai/blog/june-2024-competitive-performance-results#Testing-Methodology}{deployment and operation of company's inference pipelines} using Helm, ArgoCD, Prometheus, Grafana, Elastic, Kibana, HPA
\end{tightemize}
\sectionsep
...
StackOverflow: \href{http://stackoverflow.com/users/553720/vadim-eisenberg}{553720/vadim-eisenberg}, reputation 3407 \\
