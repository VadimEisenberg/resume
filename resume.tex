...
\namesection{}{Vadim Eisenberg}{%
  Software Developer, M.Sc. in Computer Science, hands-on, generalist%
  }{%
...
\section{Skills}
Software Engineering and Architecture \textbullet{} Kubernetes \textbullet{} Programming Languages \textbullet{} Software Design \textbullet{} Design Patterns \textbullet{} Application Frameworks/Middleware \textbullet{} Semantic Web and Database technologies \textbullet{} Mobile and Web applications \textbullet{} Microservices and Service Meshes
\sectionsep

\subsection{Programming}
Java \textbullet{} Go \textbullet{} JavaScript \textbullet{} Python \textbullet{} C\\
C++ \textbullet{} Ruby  \textbullet{}  Swift \textbullet{} Bash \textbullet{}  Assembly
\sectionsep
...
Git \textbullet{}  Make \textbullet{}  Bash \textbullet{} Ansible \textbullet{} \\
...
\runsubsection{NeuReality}
\descript{| Cloud Architect}
\location{2023-- | Caesarea, Israel}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Integration of NeuReality hardware and software with Kubernetes
\item Implemented device plugins, Calico dataplane driver, operators
\item Designed deployment and operation of company's inference pipelines using Helm, ArgoCD, Prometheus, Grafana, Elastic, Kibana, HPA, NVIDIA Dynamo and
  \href{https://www.linkedin.com/posts/vadimeisenberg_llmd-kubernetes-llminference-activity-7411405769872506880-RZqy}{llm-d}
\end{tightemize}
\sectionsep
...
Contributor \href{https://github.com/istio/istio/graphs/contributors}{\#46} to \href{https://github.com/istio/istio}{istio/istio}, \href{https://github.com/istio/istio.io/graphs/contributors}{\#10} to \href{https://github.com/istio/istio.io}{istio/istio.io}. Consulting a large enterprise on their Istio adoption.
\item Development of \href{https://github.com/Kitura/Kitura}{Kitura - a Swift web framework}. Contributor \href{https://github.com/Kitura/Kitura/graphs/contributors}{\#1}.
...
StackOverflow: \href{http://stackoverflow.com/users/553720/vadim-eisenberg}{553720/vadim-eisenberg}, reputation 3467 \\
